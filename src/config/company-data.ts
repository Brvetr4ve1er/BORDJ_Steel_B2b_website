export const companyData = {
  ...
  "portfolio": {
    ...
    "projects": [
      ...
      {
        "name": "Multi-Storey Commercial Tower",
        "image": {
          "src": "https://placehold.co/400x300.png",
      ...
      {
        "name": "Airport Hangar Structure",
        "image": {
          "src": "https://placehold.co/400x300.png",
          "aiHint": "airport hangar"
        }
      },
      {
        "name": "Pedestrian Steel Bridge",
        "image": {
          "src": "https://placehold.co/400x300.png",
          "aiHint": "steel bridge"
        }
...
export const navItems = ['Home', 'About', 'Services', 'Portfolio', 'Approvals', 'Clients', 'Contact'];
