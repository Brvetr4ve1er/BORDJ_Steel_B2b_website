...
export const companyData = {
  ...
  pages: {
    ...
    references: {
      ...
      projects: [
          { name: 'UTEC', location: 'Ain Oulmen', image: { src: 'https://images.unsplash.com/photo-1553413077-190dd305871c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw5fHxpbmR1c3RyaWFsJTIwd2FyZWhvdXNlfGVufDB8fHx8MTc1NTY4MjMzMXww&ixlib=rb-4.1.0&q=80&w=1080', aiHint: 'industrial warehouse' } },
          { name: 'STAR GOOD', location: 'Oued Smar', image: { src: 'https://images.unsplash.com/photo-1580741753044-b3f303ad361b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw3fHxjb21tZXJjaWFsJTIwYnVpbGRpbmd8ZW58MHx8fHwxNzU1NjM2MzgyfDA&ixlib=rb-4.1.0&q=80&w=1080', aiHint: 'commercial building' } },
          { name: 'CFCE', location: 'Oran', image: { src: 'https://images.unsplash.com/photo-1642023510626-763f3c06e7b4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw0fHxleGhpYml0aW9uJTIwY2VudGVyfGVufDB8fHx8MTc1NTY4MjMzMXww&ixlib=rb-4.1.0&q=80&w=1080', aiHint: 'exhibition center' } },
          { name: 'Base Logistique CONDOR', location: '', image: { src: 'https://images.unsplash.com/photo-1628361147053-170fe2184bdc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyfHxsb2dpc3RpY3MlMjBiYXNlfGVufDB8fHx8MTc1NTY4MjMzMXww&ixlib=rb-4.1.0&q=80&w=1080', aiHint: 'logistics base' } },
          { name: 'Softal', location: 'Boufarik', image: { src: 'https://images.unsplash.com/photo-1516937941344-00b4e0337589?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwyfHxpbmR1c3RyaWFsJTIwZmFjdG9yeXxlbnwwfHx8fDE3NTU2ODIzMzF8MA&ixlib=rb-4.1.0&q=80&w=1080', aiHint: 'industrial factory' } },
          { name: 'Duct & Piping', location: '(Bordj Steel)', image: { src: 'https://images.unsplash.com/photo-1603417405991-4fd97e52ccea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMHx8cGlwaW5nJTIwc3lzdGVtfGVufDB8fHx8MTc1NTY4MjMzMXww&ixlib=rb-4.1.0&q=80&w=1080', aiHint: 'piping system' } },
      ]
    },
    certifications: {
    ...
    clients: {
      ...
      logos: [
        { name: "Condor", image: { src: "/logos/condor.png", aiHint: "Condor logo" } },
        { name: "Cosider", image: { src: "/logos/cosider.png", aiHint: "Cosider logo" } },
        { name: "UTEC", image: { src: "/logos/utec.png", aiHint: "UTEC logo" } },
        { name: "Biolab", image: { src: "/logos/biolab.png", aiHint: "Biolab logo" } },
        { name: "Hyundai", image: { src: "/logos/hyundai.png", aiHint: "Hyundai logo" } },
        { name: "Softal", image: { src: "/logos/softal.png", aiHint: "Softal logo" } },
        { name: "Batimetal", image: { src: "/logos/batimetal.png", aiHint: "Batimetal logo" } },
        { name: "Man", image: { src: "/logos/man.png", aiHint: "Man logo" } },
        { name: "Cevital", image: { src: "/logos/cevital.png", aiHint: "Cevital logo" } },
        { name: "Metidji", image: { src: "/logos/metidji.png", aiHint: "Metidji logo" } },
        { name: "Soummam", image: { src: "/logos/soummam.png", aiHint: "Soummam logo" } },
        { name: "Sim", image: { src: "/logos/sim.png", aiHint: "Sim logo" } },
        { name: "Mobilis", image: { "src": "/logos/mobilis.png", "aiHint": "Mobilis logo" } },
        { name: "Amimer Energie", image: { "src": "/logos/amimer_energie.png", "aiHint": "Amimer Energie logo" } },
        { name: "Danone", image: { "src": "/logos/danone.png", "aiHint": "Danone logo" } },
        { name: "Ifri", image: { "src": "/logos/ifri.png", "aiHint": "Ifri logo" } },
        { name: "Sonatrach", image: { "src": "/logos/sonatrach.png", "aiHint": "Sonatrach logo" } },
        { name: "GCB", image: { "src": "/logos/gcb.png", "aiHint": "GCB logo" } },
        { name: "Imetal", image: { "src": "/logos/imetal.png", "aiHint": "Imetal logo" } }
      ]
    },
    contact: {
      slug: '/contact',
