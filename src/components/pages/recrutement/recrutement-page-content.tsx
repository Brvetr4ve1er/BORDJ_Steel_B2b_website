/**
 * Recruitment Page Content Component
 *
 * Displays available job listings, filtering controls, and a spontaneous application form.
 * Uses client-side state to manage search filters for specific job categories and types.
 */
"use client";
...
export const RecruitmentPageContent = () => {
