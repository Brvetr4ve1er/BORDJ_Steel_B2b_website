 ...
 *
 * Provides a central hub for all media center content including blog posts,
 * ISO certifications, and downloadable catalogs. Uses a tabbed interface
 * powered by a responsive "Dock" component to navigate between sections.
 */
"use client";
