...
export default function ToleNervureeProduct({ product, gallery1, gallery2, gallery3 }: { product: any, gallery1: React.ReactNode, gallery2: React.ReactNode, gallery3: React.ReactNode }) {
    if (!product) {
    ...
    return (
        <div className="grid grid-cols-1 gap-8 md:gap-12 lg:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="lg:col-span-1 xl:col-span-2">
                ...
                <h2 className="text-xl font-bold text-accent my-4">TÔLE NERVURÉE TN40</h2>
