    ...
    <div className="bg-background p-4">
      ...
      <table className="w-full border-collapse text-sm">
        ...
        <tbody>
          ...
          {/* Data Rows */}
          {[
            { kg: 60, dan: 58, vals: [285, 315, 345, 485, 400, 400, 455, 505, 550, 560] },
            { kg: 80, dan: 78, vals: [255, 285, 315, 485, 375, 405, 445, 490, 495, null] },
            { kg: 100, dan: 98, vals: [235, 265, 300, 415, 375, 385, 410, 460, 470, null] },
            { kg: 120, dan: 117, vals: [225, 255, 280, 345, 355, 360, 385, 430, 450, null] },
            { kg: 140, dan: 137, vals: [205, 225, 250, 310, 340, 340, 370, 420, 430, null] },
            { kg: 160, dan: 156, vals: [195, 215, 235, 280, 325, 325, 345, 370, 370, null] },
          ].map((row, rowIndex) => (
            <tr key={rowIndex} className={rowIndex % 2 === 0 ? 'bg-background' : 'bg-muted/50'}>
              <td className="border border-border px-3 py-2 font-semibold text-center">{row.kg}</td>
              <td className="border border-border px-3 py-2 font-semibold text-center">{row.dan}</td>
              {row.vals.map((val, valIndex) => (
