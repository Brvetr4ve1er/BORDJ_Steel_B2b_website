    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-primary max-w-4xl">
          Notre Parcours à Travers le Temps
        </h2>
        <p className="text-muted-foreground text-sm md:text-base max-w-sm">
          Depuis notre création, nous avons forgé un chemin d'innovation et d'excellence dans la construction métallique. Voici les étapes clés de notre histoire.
        </p>
      </div>
