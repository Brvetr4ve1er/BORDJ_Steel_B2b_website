                  ...
                  {isLeft && (
                    <>
                      ...
                      <div className="col-span-1 h-full relative">
                        ...
                        <div className="absolute left-1/2 top-1/2 w-5 h-5 bg-accent rounded-full border-4 border-gray-50 shadow-md z-10 transform -translate-x-1/2 -translate-y-1/2" aria-hidden="true" />
                      </div>
