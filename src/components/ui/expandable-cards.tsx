...
export default function ExpandableCards({
  ...
  return (
    <div
      className={cn("flex w-full flex-col gap-4 overflow-scroll p-4", className)}
    >
      <div
      ...
      >
        {cards.map((card) => (
          <motion.div
            ...
            className={cn("relative mr-4 h-[300px] shrink-0 cursor-pointer overflow-hidden rounded-2xl border bg-background shadow-lg", cardClassName)}
